...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1jbo4f6");
    			add_location(img, file$2, 117, 36, 4104);
    			attr_dev(div0, "class", "icon");
    			add_location(div0, file$2, 117, 18, 4086);
    			attr_dev(input0, "id", "magic");
    			attr_dev(input0, "size", input0_size_value = /*raw*/ ctx[0].length > 40 ? 40 : /*raw*/ ctx[0].length);
    			attr_dev(input0, "class", "svelte-1jbo4f6");
    			add_location(input0, file$2, 118, 18, 4165);
    			add_location(div1, file$2, 124, 18, 4414);
    			attr_dev(div2, "class", "wrapper svelte-1jbo4f6");
    			set_style(div2, "display", "flex");
    			add_location(div2, file$2, 116, 12, 4025);
    			attr_dev(input1, "type", "submit");
    			set_style(input1, "display", "none");
    			add_location(input1, file$2, 126, 12, 4465);
    			attr_dev(form, "class", "svelte-1jbo4f6");
    			add_location(form, file$2, 115, 6, 3973);
    			attr_dev(div3, "id", "staticBox");
    			add_location(div3, file$2, 128, 6, 4530);
    			...
    			add_location(section, file$2, 112, 0, 3802);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 1 && t_value !== (t_value = /*link*/ ctx[1].name + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$3, 9, 0, 87);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Links> was created with unknown prop '${key}'`);
    	});
    ...
    class Links extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*data*/ ctx[0] === undefined && !("data" in props)) {
    			console_1$1.warn("<Links> was created without expected prop 'data'");
    		}
    	}
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*sites*/ ctx[0] === undefined && !("sites" in props)) {
    			console_1$2.warn("<App> was created without expected prop 'sites'");
    		}

    		if (/*days*/ ctx[2] === undefined && !("days" in props)) {
    			console_1$2.warn("<App> was created without expected prop 'days'");
    		}

    		if (/*links*/ ctx[1] === undefined && !("links" in props)) {
    			console_1$2.warn("<App> was created without expected prop 'links'");
    		}
    	}
