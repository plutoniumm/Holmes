...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$2, 63, 36, 1926);
    			attr_dev(div0, "class", "icon");
    			add_location(div0, file$2, 63, 18, 1908);
    			...
    			add_location(input0, file$2, 64, 18, 1987);
    			add_location(div1, file$2, 70, 18, 2236);
    			attr_dev(div2, "class", "wrapper svelte-yz0cu2");
    			set_style(div2, "display", "flex");
    			add_location(div2, file$2, 62, 12, 1847);
    			attr_dev(input1, "type", "submit");
    			set_style(input1, "display", "none");
    			add_location(input1, file$2, 72, 12, 2287);
    			attr_dev(form, "class", "svelte-yz0cu2");
    			add_location(form, file$2, 61, 6, 1802);
    			...
    			add_location(section, file$2, 58, 0, 1631);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "keyup", /*go*/ ctx[3], false, false, false),
    					listen_dev(input0, "input", /*input0_input_handler*/ ctx[8]),
    					listen_dev(form, "submit", /*submitHandler*/ ctx[4], false, false, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("sites" in $$props) $$invalidate(5, sites = $$props.sites);
    	};
    ...
    class Search extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { sites: 5 });
    		...
    		if (/*sites*/ ctx[5] === undefined && !("sites" in props)) {
